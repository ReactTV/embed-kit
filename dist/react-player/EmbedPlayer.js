 ...
 */
export function EmbedPlayer({ url, width = defaultWidth, height = defaultHeight, autoplay, onReady, onPlay, onPause, onBuffering, onEnded, onProgress, onMute, onError, onUnsupportedUrl, className, style, ...restOptions }) {
