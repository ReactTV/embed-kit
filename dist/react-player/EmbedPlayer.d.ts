...
export interface EmbedPlayerProps extends Omit<ICreatePlayerOptions, "onError" | "onReady"> {
 ...
 */
export declare function EmbedPlayer({ url, width, height, autoplay, onReady, onPlay, onPause, onBuffering, onEnded, onProgress, onMute, onError, onUnsupportedUrl, className, style, ...restOptions }: EmbedPlayerProps): React.ReactElement;
//# sourceMappingURL=EmbedPlayer.d.ts.map